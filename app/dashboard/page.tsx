  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="flex flex-row justify-evenly mx-20 mt-5">
            <div className="flex flex-col items-center justify-center bg-gray-50 w-92 h-88 rounded-md shadow-lg">
    ...
    <div className="flex flex-col bg-gray-50 items-center rounded-md shadow-lg p-15 mx-20 mt-5  ">
